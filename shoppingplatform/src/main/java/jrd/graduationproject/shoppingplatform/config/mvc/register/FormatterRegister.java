...
import jrd.graduationproject.shoppingplatform.config.mvc.OrderStatusEnumConverter;
...
public class FormatterRegister {
	...
	@Bean
	public Converter<String, OrderStatusEnum> formatterOrderStatusEnumRegistration() {
		return new OrderStatusEnumConverter();
	}
}
